...
\teamnote{UCPC 2026}{팀명고민하기귀찮음}{닉네임(jwpassion1), 정하기(yyyy7089), 귀찮음(overnap)}
...
{}
{$\mathcal{O}(N\log N)-\mathcal{O}(1)$, even with non-idempotent operation}
{cpp}
{source/DisjointSparseTable.cpp}
{overnap}
